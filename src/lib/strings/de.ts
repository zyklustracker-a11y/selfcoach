...
export const de = {
  ...
  todos: {
    ...
    empty: {
      today: 'Für heute steht nichts an.',
      open: 'Nichts offen.',
      principles: 'Noch kein Vorsatz. Vorsätze entstehen aus Einträgen, die dauerhaft gelten sollen.',
      done: 'Noch nichts abgehakt.',
    },
    carriedOver: 'Von gestern',
    carriedOverHint: 'Verschieben oder verwerfen — nichts sammelt sich stillschweigend an.',
    postpone: 'Auf heute schieben',
    drop: 'Verwerfen',
    postponed: (n: number) => (n === 1 ? 'Einmal verschoben' : `${n}-mal verschoben`),
    // Created inline from the entry form (concept 6.3, step 7).
    create: 'To-do daraus erstellen',
    createOpen: 'Kein To-do daraus',
    title: 'Aufgabe',
    kind: 'Art',
    kindDaily: 'Für heute',
    kindPrinciple: 'Dauerhafter Vorsatz',
    kindDailyHint: 'Ein Schritt mit Datum. Nicht erledigt, wird morgen gefragt.',
    kindPrincipleHint: 'Gilt ab jetzt. Wird nicht abgehakt, sondern im Wochenreview angeschaut.',
    derived: 'Daraus geworden',
    open2: 'Offen',
    doneAt: 'Erledigt',
  },
  today: {
